  ...
  const action = {
    alliteration: {
      short: () => {
        const randomAdjective =
          adjectives[letter.toLowerCase()][
            Math.floor(Math.random() * adjectives[letter.toLowerCase()].length)
          ];

        const randomAnimal =
          animals[letter.toLowerCase()][
            Math.floor(Math.random() * animals[letter.toLowerCase()].length)
          ];
      ...
      long: () => {
        ...
        for (let i = 1; i <= adjectivesCount; i++) {
          if (adjectives[letter.toLowerCase()].length > 0) {
            ...
            randomAdjective =
              randomAdjective +
              adjectives[letter.toLowerCase()].splice(
                Math.floor(
                  Math.random() * adjectives[letter.toLowerCase()].length
                ),
                1
              );
          }
    ...
    mix: {
      short: () => {
        ...
        const randomAdjective =
          adjectives[adjectivesSeed][
            Math.floor(Math.random() * adjectives[adjectivesSeed].length)
          ];

        const randomAnimal =
          animals[animalsSeed][
            Math.floor(Math.random() * animals[animalsSeed].length)
          ];
      ...
      long: () => {
        ...
        for (let i = 1; i <= adjectivesCount; i++) {
          ...
          if (
            adjectiveLetter in adjectives &&
            adjectives[adjectiveLetter].length > 0
          ) {
            if (randomAdjective.length > 0) {
              randomAdjective = randomAdjective + ' ';
            }
            ...
            randomAdjective =
              randomAdjective +
              adjectives[adjectiveLetter].splice(
                Math.floor(Math.random() * adjectives[adjectiveLetter].length),
                1
              );
        ...
        var randomAnimalArray =
          animals[alphabet[Math.floor(Math.random() * (alphabet.length - 1))]];

        var randomAnimal =
          randomAnimalArray[
            Math.floor(Math.random() * (randomAnimalArray.length - 1))
          ];
